...
- 检测错误：ping/echo，monitor，timestamp，sanity checking，condition monitoring，voting，self-test
...
- Response Measure：Our information included correctly 99.9% of the time 我们的位置信息被正确包含的概率将为 99.9%
...
- Response：Transactions are processed 处理事件
